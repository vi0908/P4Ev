def add_time(start, duration, day = None):
   ...
   if int(end_minutes) <=9:
       end_time = end_hour + ':' + '0' + end_minutes + ' ' + ampm + day_week + end_day

   else:
       end_time = end_hour + ':' + end_minutes + ' ' + ampm + day_week + end_day
...
#https://replit.com/@EyckVanJan/time-calculator?v=1